...
class AbrirChamadoRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "CHAMADO_TEMPERATURA" => ["required", "string", "max:20"],
    ...
    public function attributes()
    {
        return [
            ...
            "CHAMADO_CONSELHO_PROFISSIONAL" => "<b>CONSELHO PROFISSIONAL</b>",
            "CHAMADO_NUMERO_CONSELHO" => "<b>NÚMERO DO CONSELHO</b>",
            ...
            "CHAMADO_TEMPERATURA" => "<b>TEMPERATURA</b>",
            "CHAMADO_FREQUENCIA_CARDIACA" => "<b>FREQUÊNCIA CARDÍACA</b>",
            "CHAMADO_PRESSAO_ARTERIAL" => "<b>PRESSÃO ARTERIAL</b>",
            "CHAMADO_SATURACAO_O2" => "<b>SATURAÇÃO O2</b>",
            "CHAMADO_ESCALA_GLASGOW" => "<b>ESCALA GLASGOW</b>",
